...
export const MSG_MENU_FOOTER =
  'Дальше: «Оформить заказ» (на завтра, как в CRM) · «Оставить заявку» · «Связаться с оператором».';

/** Одна строка перед текстом MENU_DAILY: отделяем анонс от заказа на завтра. */
export const MSG_VK_MENU_CONTEXT_LINE =
  'Ниже — день из CRM (анонс). На завтра список и цены — только в шаге «Оформить заказ».';

export const MSG_VK_MENU_TRUNC_HINT =
  'Полный текст — по ссылке на сайт или у оператора.';

export const MSG_MENU_EMPTY =
  'Меню дня в CRM ещё не опубликовано (VK → тип «меню дня», статус согласован/опубликован). Загляните позже или оставьте заявку.';
...
export const MSG_IDLE_CHOOSE =
  'Выберите кнопку: Меню · Оформить заказ на завтра · Заявка оператору · Связь с оператором.';
